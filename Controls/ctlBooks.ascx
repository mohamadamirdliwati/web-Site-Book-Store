<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ctlBooks.ascx.cs" Inherits="Controls_ctlBooks" %>
...
<asp:Panel runat="server" ID="pnlSearch" GroupingText="Search" DefaultButton="btnSearch">
    <table>
        ...
        <tr>
            ...
            <td> 
                <asp:DropDownList runat="server" ID="lstAuthors"  
    ...
    <asp:LinkButton runat="server" ID="btnSearch" Text="Search" 
        onclick="btnSearch_Click" />
</asp:Panel>

<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    DataKeyNames="BookID" DataSourceID="odsBooks" AllowPaging="True" Width="100%"
    AllowSorting="True" PageSize="5">
    <Columns>
        <asp:TemplateField SortExpression="BookTitle">
            <ItemTemplate>
                <asp:HyperLink ID="lnkView" runat="server"
                    ImageUrl='<%# Eval("BookID", clsGlobal.BookCoverURL) %>' 
                    NavigateUrl='<%# Eval("BookID","~/Book.aspx?bid={0}") %>' />
            </ItemTemplate>
