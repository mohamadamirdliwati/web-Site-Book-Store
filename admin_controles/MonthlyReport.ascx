<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MonthlyReport.ascx.cs" Inherits="admin_controles_MonthlyReport" %>
...
<asp:GridView ID="GridView1" runat="server" AllowPaging="True" ShowFooter="True"
    ...
    <Columns>
        <asp:BoundField DataField="SaleDate" HeaderText="Sale Date" DataFormatString="{0:MMMM yyyy}"
...
<asp:ObjectDataSource ID="odsReport" runat="server" 
    ...
    TypeName="AWPDataSetTableAdapters.MonthlySalesTableAdapter">
    <SelectParameters>
